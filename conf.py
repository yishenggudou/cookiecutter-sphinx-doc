...
copyright = u'{0}, {{cookiecutter.author}}'.format(datetime.datetime.now().year)
...
release = u'{{cookiecutter.release}}'
...
man_pages = [
    (master_doc, '{{cookiecutter.project_slug}}', u'{{cookiecutter.project}} Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '{{cookiecutter.project_slug}}', u'{{cookiecutter.project}} Documentation',
     author, '{{cookiecutter.project_slug}}', '{{cookiecutter.description}}',
     'Miscellaneous'),
]
